...
def main():
    parser = argparse.ArgumentParser(description="AMT Pipeline - Music Generation with Text Controls")
    ...
    parser.add_argument("--output_file", default="data/output/complete_dataset.json", 
    ...
    parser.add_argument("--input_file", default="data/output/complete_dataset.json", 
    ...
    parser.add_argument("--data_file", default="data/processed/training_data.json", 
