...
class MusicTransformer(nn.Module):
    ...
    def forward(self, 
                ...
                style_ids: Optional[torch.Tensor] = None) -> torch.Tensor:
        """
        ...
        if text_embeddings is not None:
            ...
            text_embeddings = self.text_pos_encoding(text_embeddings.transpose(0, 1)).transpose(0, 1)
    ...
    def generate(self, 
                 ...
                 style_id: Optional[int] = None) -> torch.Tensor:
        """
        ...
        for i in range(1, max_length):
            ...
            with torch.no_grad():
                logits = self.forward(
                    current_seq, text_embeddings, 
                    tempo_ids=tempo_ids, key_ids=key_ids, style_ids=style_ids
                )
