"""
Evaluation Metrics - Detailed metrics for music evaluation
"""
...
class EvaluationMetrics:
    ...
    def __init__(self):
        self.metric_names = [
            'note_density', 'velocity_diversity', 'pitch_range', 
            'rhythm_consistency', 'melodic_contour', 'harmonic_complexity',
            'tempo_stability', 'dynamic_range', 'structural_coherence'
        ]
