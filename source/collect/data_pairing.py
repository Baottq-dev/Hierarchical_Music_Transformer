...
class DataPairing:
    ...
    def create_paired_dataset(self, output_file: str = "data/output/paired_data.json") -> List[Dict[str, Any]]:
    ...
    def filter_paired_data(self, paired_data: List[Dict[str, Any]], 
...
def create_complete_dataset(midi_dir: str = "data/midi", 
                           output_file: str = "data/output/complete_dataset.json",
                           filter_quality: bool = True) -> List[Dict[str, Any]]:
