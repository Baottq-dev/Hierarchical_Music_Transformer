...
class MusicGenerator:
    ...
    def generate_music(
        ...
        **generation_kwargs,
        ...
        # Save MIDI file (support Windows-style backslash paths on POSIX)
        out_dir = os.path.dirname(os.path.normpath(output_file))
        if out_dir == "":
            out_dir = "."
            ...
            if event["type"] == "note_on":
                ...
                if pitch in active_notes:
                    ...
                    note = pretty_midi.Note(
                        velocity=64, pitch=pitch, start=start_time, end=end_time
                    )
    ...
    def generate_with_controls(
        self, text_description: str, output_file: str, controls: Dict[str, Any]
    ) -> Dict[str, Any]:
...
def generate_from_text(
    ...
    **kwargs,
    ...
    return generator.generate_music(
        text_description=text_description, output_file=output_file, style_id=style_id, **kwargs
    )
